...
async function start(){
  ...
  if(extra.status==='fulfilled'&&multisite.status==='fulfilled'&&audit.status==='fulfilled'&&current.status==='fulfilled'&&current2.status==='fulfilled'&&current3.status==='fulfilled'&&current4.status==='fulfilled')$('svc-load-status').hidden=true;
  else{
    const missing=[];
