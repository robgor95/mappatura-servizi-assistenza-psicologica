...
const config = {
  ...
  "routes": {
    ...
    "consultori": {
      "label": "Consultori familiari",
      "page": "/supporto-territoriale.html",
      "description": "Rete regionale dei consultori: famiglia, adolescenza, genitorialità e sostegno psicologico/sociale.",
      "filters": {
        "categoria": "Consultorio"
      }
    },
    "young-listening": {
      "label": "Consultori e Spazio Giovani",
      "page": "/supporto-territoriale.html",
      "description": "Consultori e percorsi per adolescenti e giovani; verifica attività e orari della sede.",
      "filters": {
        "categoria": "Consultorio"
      }
    },
    ...
    "safety": {
      "label": "Ho bisogno di aiuto adesso",
      "page": "/aiuto-adesso.html",
      "description": "Distingue emergenza, sanità non urgente, emergenza sociale, violenza e tutela dei minori."
    },
    "violence": {
      "label": "Violenza e centri antiviolenza",
      "page": "/aiuto-adesso.html#violenza",
      "description": "1522 e mappa pubblica dei CAV. Le Case Rifugio non vengono geolocalizzate."
    },
    "guides": {
    ...
    "pua": {
      "label": "Punti Unici di Accesso · PUA",
      "page": "/supporto-territoriale.html",
      "description": "Orientamento e accesso integrato a servizi sociali, sociosanitari e sanitari.",
      "filters": {
        "categoria": "PUA"
      }
    },
    "pis": {
      "label": "Pronto Intervento Sociale · PIS",
      "page": "/supporto-territoriale.html",
      "description": "Emergenze sociali: numeri e modalità dipendono dal distretto.",
      "filters": {
        "categoria": "PIS"
      }
    },
    "territorial-support": {
      "label": "Supporto territoriale",
      "page": "/supporto-territoriale.html",
      "description": "Consultori, PUA, PIS e collegamenti ai servizi specialistici."
    },
    "case-comunita": {
      "label": "Case della Comunità e PUA",
      "page": "/supporto-territoriale.html",
      "description": "Accesso territoriale: non ogni Casa della Comunità offre automaticamente supporto psicologico.",
      "filters": {
        "categoria": "PUA"
      }
    }
  ...
  "notes": {
    ...
    "territorial-support": "Il bisogno sociale o sociosanitario non viene trasformato in una diagnosi: Menta propone soltanto punti di accesso e orientamento."
  }
};
