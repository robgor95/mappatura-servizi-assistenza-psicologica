...
async function load(){
  const result=await Promise.allSettled(['/data/portal_data_v7_3.json','/data/privati_v7_5.json','/data/multisede_v7_7_5.json','/data/presidi_geo_v7_9_2.json','/data/audit_operativo_v7_9.json','/data/audit_operativo_v7_9_1.json','/data/audit_operativo_v7_9_2.json'].map(json));
