...
for(const f of ['servizi-data-v7-5-1','audit-data-v7-9','audit-data-v7-9-1','audit-data-v7-9-2','audit-data-v7-9-3','audit-data-v7-9-4'])vm.runInContext(fs.readFileSync('assets/'+f+'.js','utf8'),sandbox);
...
fs.writeFileSync(process.argv[2]||'/tmp/current-rows-v794.json',JSON.stringify(rows,null,2));console.log(rows.length+' services');
